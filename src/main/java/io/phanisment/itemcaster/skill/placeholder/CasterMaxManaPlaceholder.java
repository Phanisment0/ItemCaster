...
@MythicPlaceholder(placeholder="caster.max_mana")
public class CasterMaxManaPlaceholder extends EntityNumericPlaceholder implements MetaPlaceholder {
	public CasterMaxManaPlaceholder(PlaceholderExecutor manager, MythicLineConfig config, String[] args) {
