...
@MythicMechanic(author="Phanisment", name="addamountitem", description="Add amount item")
public class AddAmountItemMechanic extends ItemMechanic {
	private int amount;
	
	public AddAmountItemMechanic(SkillExecutor manager, File file, String line, MythicLineConfig mlc) {
