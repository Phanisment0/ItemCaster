...
public class ActivatorListMenuContext {
	...
	public ActivatorListMenuContext(CasterItem item, ItemAbilityMenuContext previous_context, SkillAttribute attribute, int index) {
		this.item = item;
	...
	public void open(Player player) {
		MenuManager.ACTIVATOR_LIST_MENU.open(player, this);
	}
