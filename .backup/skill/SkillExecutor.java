...
public class SkillExecutor {
	...
	public SkillExecutor setAttribute(SkillAttribute attributes) {
		this.power = attributes.get(Key.POWER, Float.class, 1.0f);
		this.cooldown = attributes.get(Key.COOLDOWN, Double.class, null);
		this.variables = attributes.get(Key.VARIABLES, Map.class, new HashMap<>());
		this.show_cooldown = attributes.get(Key.SHOW_COOLDOWN, Boolean.class, false);
		return this;
	}

	public void execute() {
		player.sendMessage("s: " + skill.getInternalName());
