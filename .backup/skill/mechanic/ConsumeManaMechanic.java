...
public class ConsumeManaMechanic implements ITargetedEntitySkill {
	private final PlaceholderDouble amount;
	public ConsumeManaMechanic(MythicLineConfig config) {
	...
	public SkillResult castAtEntity(SkillMetadata meta, AbstractEntity target) {
		if (target.getBukkitEntity() instanceof Player player) {
			if (Storage.mana_engine_type == ManaType.AURA_SKILLS) {
				...
				return user.consumeMana(amount.get(target)) ? SkillResult.SUCCESS : SkillResult.CONDITION_FAILED;
