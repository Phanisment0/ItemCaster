...
public class MaxManaCondition implements IEntityCondition, ISkillMetaComparisonCondition {
	private final PlaceholderString amount;
	public MaxManaCondition(final MythicLineConfig config) {
	...
	public boolean check(AbstractEntity e) {
		...
		if (entity instanceof Player player) {
			if (Storage.mana_engine_type == ManaType.AURA_SKILLS) {
				...
				return new RangedDouble(amount.get(e)).equals(user.getMaxMana());
